...
/**
 * Kirjautumisessa kysytään käyttäjältä tunnuksia ja avataan ohjelma tunnuksien mukaiseen näkymään.
 * 
 * @author Majavapaja
 */
...
public class Kirjautuminen extends JPanel {
	 ...
	 * 
	 * @param paaikkuna
	 *            pääikkuna, johon näkymä sijoitetaan.
	 */
	...
	/**
	 * Poimii kirjautumistiedot näkymästä ja tarkastaa niiden oikeudet tietokannasta.
	 */
	...
	/**
	 * Kirjaa käyttäjän sisään ohjelmaan, eli luo näkymät käyttäjän oikeuksien mukaisesti.
	 * 
	 * @param ktunnus
	 *            sisäänkirjautuvan käyttäjän tunnukset.
	 */
	public void kirjaudu(Kayttajatunnus ktunnus) {
		ikkuna.setJMenuBar(new Menupalkki(ikkuna, ktunnus));
		if (ktunnus.getOikeudet() == Kayttajatunnus.OPPILAS) {
			ikkuna.edellinenPaneeli();
			ikkuna.vaihdaPaneeli(new MuokkaaLukkaria(ktunnus.getOppilas().getRyhma(), ktunnus.getOikeudet()));
		} else {
			ikkuna.edellinenPaneeli();
		}
	}
